...
class CounterWithDelayActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CounterWithDelayFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CounterWithDelayActionFeedback
    ...
    bufferOffset = CounterWithDelayFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CounterWithDelayActionFeedback
    let len;
    let data = new CounterWithDelayActionFeedback(null);
    ...
    data.feedback = CounterWithDelayFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CounterWithDelayActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CounterWithDelayFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CounterWithDelayFeedback()
    }
...
module.exports = CounterWithDelayActionFeedback;
